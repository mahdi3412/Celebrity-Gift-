...
export class GiftsService{
 ...
 private sanitizeForUser(gift:any,userId:string,role:Role){const base={...gift};if(role==="creator"&&gift.creatorId===userId){delete base.fanId;base.senderAnonymous=true;}else if(role==="fan"&&gift.fanId===userId){delete base.creatorId;base.qrPayload="celebrity-gift://"+gift.giftCode;}else if(role==="admin"||role==="station_staff"){base.qrPayload="celebrity-gift://"+gift.giftCode;}return base;}
