...
export class GiftsService{
 ...
 private sanitizeForUser(gift:any,userId:string,role:Role){const base={...gift};if(role==="creator"&&gift.creatorId===userId){delete base.fanId;base.senderAnonymous=true;}else if(role==="fan"&&gift.fanId===userId){delete base.creatorId;}return base;}
