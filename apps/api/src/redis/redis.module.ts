...
@Injectable()
class RedisLifecycleService implements OnModuleDestroy{constructor(private readonly client:any){}async onModuleDestroy(){if(this.client?.isOpen)await this.client.quit();}}
@Global()
